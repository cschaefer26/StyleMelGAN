...
from stylemelgan.discriminator import MultiScaleDiscriminator, MultiPeriodDiscriminator, MultiSubBandDiscriminator
...
if __name__ == '__main__':
    ...
    p_model = MultiSubBandDiscriminator().to(device)
