        ...
        for i, data in pbar:
            ...
            if step % train_cfg['eval_steps'] == 0:
                ...
                for i, val_data in enumerate(val_dataset):
                    ...
                    wav_fake, fake_pitch = g_model.inference(val_mel, return_pitch=True)
                    ...
                    val_wavs.append((wav_fake, wav_real, val_pitch, fake_pitch))
                ...
                wav_fake, wav_real, pitch_target, pitch_fake = val_wavs[-1]
