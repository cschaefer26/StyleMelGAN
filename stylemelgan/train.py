...
if __name__ == '__main__':
    ...
    try:
        checkpoint = torch.load('checkpoints/latest_model_neurips_disc4_nostft.pt', map_location=device)
    ...
    summary_writer = SummaryWriter(log_dir='checkpoints/logs_neurips_disc4_nostft')
    ...
    for epoch in range(10000):
            ...
            if step % 10000 == 0:
                ...
                if val_norm_loss + val_spec_loss < best_stft:
                    ...
                    torch.save({
                        ...
                        'config': config,
                        'step': step
                    }, 'checkpoints/best_model_neurips_disc4_nostft.pt')
        ...
        torch.save({
            ...
            'config': config,
            'step': step
        }, 'checkpoints/latest_model_neurips_disc4_nostft.pt')