...
class HifiganGenerator(torch.nn.Module):
    ...
    def inference(self,
        ...
        with torch.no_grad():
            pad = torch.full((1, 80, pad_steps),
                             -11.5129).to(mel.device)
    ...
    def from_config(cls, config_file: str) -> 'HifiganGenerator':
        ...
        return HifiganGenerator(h)



if __name__ == '__main__':

    model = HifiganGenerator.from_config('/Users/cschaefe/workspace/hifi-gan/config_v2.json')
